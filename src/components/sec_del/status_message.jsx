      ...
      <div className="row border p-3 shadow-sm">
        ...
        {Iam_delegate ? (
          <>
            ...
            <p>
              Only the F-Del can dissolve a Circle, and may only do so when they
        ...
        {Iam_member === true && Iam_delegate === false ? (
          <>
            ...
            <p>
              ...
              sure it is the most recent (currently valid) CIK generated by the
              F-Del. If you encounter any problems, please contact the F-Del In
              Real Life, or ElseWhere On The Internet.{" "}
            </p>
            <p>
              Until this Circle becomes active, you can be removed by the F-Del
              at any time.{" "}
            </p>
            <span>
        ...
        {Iam_candidate ? (
          <>
            ...
            <p>
              {" "}
              If you shouldn’t be trying to join this Circle for any reason, the
              F-Del can remove you as a member candidate. After that happens,
              you will not be able to attempt to join this Circle unless you are
              given a new Invitation Key. Ask your F-Del IRL.
            </p>
            <p>
              {" "}
              The creator of this Circle has been automatically made First
