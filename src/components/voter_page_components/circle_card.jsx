...
export default function CircleCard() {
  const CopyInviteKey = (value) => {
    navigator.clipboard
      .writeText(value)
      .then(() => {
        alert("Invitation key copied to clipboard");
      })
      .catch((err) => {
        console.log("field to copy: ", err);
          ...
          <div className="card rounded-3 bg-light p-4">
            <div className="row">
              ...
              <div className="col-sm-12 col-md-8 text-center">
                <h1 className="fs-3 m-0 text-center">Circle-NY01-12321</h1>
                <div className="d-flex justify-content-between  border-bottom border-1">
                  <p className="m-0">Status: Active</p>
                  <p className="m-0">members: 7</p>
                </div>
                <h1 className="fs-3">Invitation Key</h1>
                <div className="row">
                  <div className="col-sm-12 col-md-3"></div>
                  <div className="col-sm-12 col-md-6">
                    <div className="d-flex justify-content-center border rounded-2 p-1">
                      <p className="fw-light font-monospace m-0" style={{ letterSpacing: ".3rem" }}>
                        1232423123
                      </p>
                      &nbsp; &nbsp;
                      <button
            ...
            <div className="row">
              <div className="d-flex flex-sm-column flex-md-row justify-content-around  flex-wrap mt-3 ">
                <Link to="/house-keeping-page" className="py-1 text-nowrap">
                  Voter Settings &nbsp;
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
