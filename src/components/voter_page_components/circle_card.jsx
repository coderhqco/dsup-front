              ...
              <>
                  ...
                  <div className="col-sm-12 col-md-8 text-center">
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-12 col-md-6">
                        <div className="d-flex flex-wrap justify-content-center border rounded-2 p-1">
                          <p
                          ...
                          &nbsp; &nbsp;
                          <button
                            onClick={() => CopyInviteKey("12312312")}
                ...
                <div className="row">
                  <div className="d-flex flex-sm-column flex-md-row justify-content-around  flex-wrap mt-3 ">
                    <Link to="/voter-page" className="py-1 text-nowrap fw-light text-dark">
                      Voter Settings &nbsp;
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <Link to="/circle-back-n-forth" className="py-1 text-nowrap fw-light text-dark">
                      Back And Forth &nbsp;
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <Link to="/house-keeping-page" className=" py-1 text-nowrap fw-light text-dark">
                      Housekeeping Page &nbsp;
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <Link to="/member-contact" className=" py-1 text-nowrap fw-light text-dark">
                      Member Contact Page &nbsp;
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <Link
                      to="/meetings-and-minutes"
                      className="py-1 text-nowrap fw-light text-dark">
                      Meetings & Minutes &nbsp;
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                ...
                <div className="row">
                  {AuthUser.users.userType === 1 ? (
                    <div className="d-flex flex-sm-column flex-md-row justify-content-evenly mt-4 ">
                      <Link to="/house-keeping-page" className="py-1 text-nowrap text-dark">
                        Create F-Link
                      </Link>
